...
public class xHome {
    ...
    void tekanData(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("databuku.fxml"));
    ...
    void tekanKunjungan(ActionEvent event) throws IOException {
        anchor.getChildren().clear();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("kunjungan.fxml"));
        Parent parent = loader.load();
        anchor.getChildren().add(parent);
    }
    ...
    void tekanPeminjaman(ActionEvent event)  throws IOException {
        anchor.getChildren().clear();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("peminjaman.fxml"));
        Parent parent = loader.load();
        anchor.getChildren().add(parent);
    }
    ...
    void tekanPengembalian(ActionEvent event) throws IOException {
        anchor.getChildren().clear();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("pengembalian.fxml"));
        Parent parent = loader.load();
        anchor.getChildren().add(parent);
    }
    ...
    void tekanTambah(ActionEvent event) throws IOException {
        anchor.getChildren().clear();
        FXMLLoader loader = new FXMLLoader(getClass().getResource("anggota.fxml"));
        Parent parent = loader.load();
        anchor.getChildren().add(parent);
    }
